    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>List Pembelian Barang</h2></div>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="delete" title="Delete" data-toggle="tooltip" href="{{route('datapc.destroy', ['id' => $datakomputer->snid])}}" onclick="return confirm('Apakah PC akan dihapus')">
                                ...
                                {{Form::model($barang,['method' => 'delete','route' =>['databelibarang.destroy',$barang->id],'class'=>'form-inline'])}}

                                <a class="edit" title="Edit" data-toggle="tooltip" href="{{url('editbelibarang/'.$barang->id)}}"> <i class="material-icons">&#xE254;</i></a>
