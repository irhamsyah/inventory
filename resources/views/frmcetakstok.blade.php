...
@include('layout.flashmessage')
    ...
    <div class="row">
      ...
      {!!Form::open(['route'=>'viewreportstok','method'=>'get','files'=>true,'enctype'=>'multipart/form-data']) !!}
      {{ csrf_field() }}

      <h2><label for="basic-url" class="form-label mt-3">Cetak Laporan STOK</label></h2>
