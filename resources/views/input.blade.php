  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="input-group mb-3 mt-3 w-50">
        ...
        <input type="text" name="snid" class="form-control" placeholder="Serial Number PC" aria-label="Username" aria-describedby="basic-addon1">
      </div>
      
      <div class="input-group mb-3 w-50">
        <span class="input-group-text" id="basic-addon1">Model</span>
        <input type="text" name="model" class="form-control" placeholder="Model PC" aria-label="Recipient's username" aria-describedby="basic-addon2">
      ...
      <div class="input-group mb-3 w-50">
        ...
        <input type="text" name="type" class="form-control" id="basic-url" placeholder="Type PC" aria-describedby="basic-addon3">
      </div>
