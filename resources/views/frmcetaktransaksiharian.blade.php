...
@include('layout.flashmessage')
    ...
    <div class="row">
      ...
      {!!Form::open(['route'=>'viewreporttransharian','method'=>'get','files'=>true,'enctype'=>'multipart/form-data']) !!}
      {{ csrf_field() }}

      <h2><label for="basic-url" class="form-label mt-3">Cetak Laporan Transaksi Harian</label></h2>
